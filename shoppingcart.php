...
<!-- mainbody-->
<div class="subBody" style="min-height:430px">
	<div class="subTitle" style="margin:0;"> <span class="catname shopcart">商品购物车</span> 
		<a href="shoppingcart.php?a=empty"><strong>清空购物车</strong></a>
		<div class="cl"></div>
	</div>
	<?php
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shoppingcart">
		...
		?>
		<tr>
			<td height="60" colspan="4" align="right" valign="bottom">
				<strong class="total">总计：</strong>
				<span class="totalprice"><?php echo $totalprice; ?></span>
				<a href="order.php" class="next">下一步</a></td>
		</tr>
	</table>
	<?php
	}
